          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <form method="post" action="{{ url('updateds/'.$data->nik)}}">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title mt-3"><b>Masukkan {{ $title }} Baru</b></h5>
                    </div>
                    <div class="modal-body">
                      <div class="form-group row mt-3">
                        ...
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="pstudi" name="pstudi" value="{{$data->pstudi}}" required>
                            </div>
                        </div>
                        <div class="form-group row mt-3">
