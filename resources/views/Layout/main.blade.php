...
<script type="text/javascript">
    $(function(){
        $(document).on('click','#deleteMhs', function(e){
            e.preventDefault();
            var data_nim = $(this).attr("data-nim");
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = "deletemhs/" + data_nim,
                    Swal.fire(
                    'Deleted!',
...
<script type="text/javascript">
    $(function(){
        $(document).on('click','#deleteDs', function(e){
            e.preventDefault();
            var data_nik = $(this).attr("data-nik");
            var data_nama = $(this).attr("data-nama");
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = "deleteds/" + data_nik,
                    Swal.fire(
                    'Deleted!',
                    data_nama + ' has been deleted.',
                    'success'
